...
public class PRCommandLog extends PRFileLog {
	...
	public static enum SubType implements PRLogSubType {
		DELETE, CUT, COPY, PASTE, UNDO, REDO, FOCUS_GAINED, FOCUS_LOST, START_RUN, STOP_RUN, START_DEBUG, STOP_DEBUG, STEP, COMPILE, SAVE, UPDATED, EXTENDED, FILE_CREATED, FILE_DELETED, START_FORMAT, END_FORMAT, DEBUG_PLAY, DEBUG_STOP, DEBUG_SPEED, DEBUG_CONT, DEBUG_BPSET, DEBUG_BPCLR, DEBUG_CHANGEMODE
	};
