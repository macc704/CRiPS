...
final class huffcodetab {
	...
	private static int ValTab1[][] = { { 2, 1 }, { 0, 0 }, { 2, 1 }, { 0, 16 },
			{ 2, 1 }, { 0, 1 }, { 0, 17 }, };

	private static int ValTab2[][] = { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 },
			{ 0, 16 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 4, 1 }, { 2, 1 },
			{ 0, 32 }, { 0, 33 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 },
			{ 0, 34 }, };

	private static int ValTab3[][] = { { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 1 },
	...
	private static int ValTab5[][] = { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 },
	...
	private static int ValTab6[][] = { { 6, 1 }, { 4, 1 }, { 2, 1 }, { 0, 0 },
	...
	private static int ValTab7[][] = { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 },
	...
	private static int ValTab8[][] = { { 6, 1 }, { 2, 1 }, { 0, 0 }, { 2, 1 },
			{ 0, 16 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 4, 1 }, { 2, 1 },
	...
	private static int ValTab9[][] = { { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 0 },
	...
	private static int ValTab10[][] = { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 },
	...
	private static int ValTab11[][] = { { 6, 1 }, { 2, 1 }, { 0, 0 }, { 2, 1 },
			{ 0, 16 }, { 0, 1 }, { 8, 1 }, { 2, 1 }, { 0, 17 }, { 4, 1 },
	...
	private static int ValTab12[][] = { { 12, 1 }, { 4, 1 }, { 2, 1 },
	...
	private static int ValTab13[][] = { { 2, 1 }, { 0, 0 }, { 6, 1 }, { 2, 1 },
	...
	private static int ValTab15[][] = { { 16, 1 }, { 6, 1 }, { 2, 1 },
	...
	private static int ValTab16[][] = { { 2, 1 }, { 0, 0 }, { 6, 1 }, { 2, 1 },
	...
	private static int ValTab24[][] = { { 60, 1 }, { 8, 1 }, { 4, 1 },
	...
	private static int ValTab32[][] = { { 2, 1 }, { 0, 0 }, { 8, 1 }, { 4, 1 },
	...
	private static int ValTab33[][] = { { 16, 1 }, { 8, 1 }, { 4, 1 },
	 ...
	 */
	private huffcodetab(String S, int XLEN, int YLEN, int LINBITS, int LINMAX,
			int REF, int[] TABLE, int[] HLEN, int[][] VAL, int TREELEN) {
	 ...
	 */
	public static int huffman_decoder(huffcodetab h, int[] x, int[] y, int[] v,
			int[] w, BitReserve br) {
		...
		do {
			...
			// ultra fast.
			/*
			 * if (bitIndex==bitsAvailable) { bitsAvailable = br.readBits(bits,
			 * 32); bitIndex = 0; }
			 */
			// if (bits[bitIndex++]!=0)
			if (br.hget1bit() != 0) {
		...
		if (h.tablename0 == '3' && (h.tablename1 == '2' || h.tablename1 == '3')) {
			 ...
			 * to make obpro.bsound bistream work.
			 */
			...
			// x and y are reversed in the obpro.bsound bitstream.
			// Reverse x and y here to make obpro.bsound bitstream work.
	...
	public static void inithuff() {
		...
		ht[10] = new huffcodetab("10 ", 8, 8, 0, 0, -1, null, null, ValTab10,
				127);
		ht[11] = new huffcodetab("11 ", 8, 8, 0, 0, -1, null, null, ValTab11,
				127);
		ht[12] = new huffcodetab("12 ", 8, 8, 0, 0, -1, null, null, ValTab12,
				127);
		ht[13] = new huffcodetab("13 ", 16, 16, 0, 0, -1, null, null, ValTab13,
				511);
		ht[14] = new huffcodetab("14 ", 0, 0, 0, 0, -1, null, null, ValTab14, 0);
		ht[15] = new huffcodetab("15 ", 16, 16, 0, 0, -1, null, null, ValTab15,
				511);
		ht[16] = new huffcodetab("16 ", 16, 16, 1, 1, -1, null, null, ValTab16,
				511);
		ht[17] = new huffcodetab("17 ", 16, 16, 2, 3, 16, null, null, ValTab16,
				511);
		ht[18] = new huffcodetab("18 ", 16, 16, 3, 7, 16, null, null, ValTab16,
				511);
		ht[19] = new huffcodetab("19 ", 16, 16, 4, 15, 16, null, null,
				ValTab16, 511);
		ht[20] = new huffcodetab("20 ", 16, 16, 6, 63, 16, null, null,
				ValTab16, 511);
		ht[21] = new huffcodetab("21 ", 16, 16, 8, 255, 16, null, null,
				ValTab16, 511);
		ht[22] = new huffcodetab("22 ", 16, 16, 10, 1023, 16, null, null,
				ValTab16, 511);
		ht[23] = new huffcodetab("23 ", 16, 16, 13, 8191, 16, null, null,
				ValTab16, 511);
		ht[24] = new huffcodetab("24 ", 16, 16, 4, 15, -1, null, null,
				ValTab24, 512);
		ht[25] = new huffcodetab("25 ", 16, 16, 5, 31, 24, null, null,
				ValTab24, 512);
		ht[26] = new huffcodetab("26 ", 16, 16, 6, 63, 24, null, null,
				ValTab24, 512);
		ht[27] = new huffcodetab("27 ", 16, 16, 7, 127, 24, null, null,
				ValTab24, 512);
		ht[28] = new huffcodetab("28 ", 16, 16, 8, 255, 24, null, null,
				ValTab24, 512);
		ht[29] = new huffcodetab("29 ", 16, 16, 9, 511, 24, null, null,
				ValTab24, 512);
		ht[30] = new huffcodetab("30 ", 16, 16, 11, 2047, 24, null, null,
				ValTab24, 512);
		ht[31] = new huffcodetab("31 ", 16, 16, 13, 8191, 24, null, null,
				ValTab24, 512);
		ht[32] = new huffcodetab("32 ", 1, 16, 0, 0, -1, null, null, ValTab32,
				31);
		ht[33] = new huffcodetab("33 ", 1, 16, 0, 0, -1, null, null, ValTab33,
				31);
	}
}
