...
public class SoundPlayer {
    ...
    public static void main(String[] args) {
        int retval = 0;
        try {
            SoundPlayer player = createInstance(args);
            if (player != null)
                player.play();
        } catch (Exception ex) {
    ...
    static public SoundPlayer createInstance(String[] args) {
    ...
    public void showUsage() {
        ...
        System.out.println("");
        System.out.println(" e.g. : java blib.sound.javazoom.jl.player.jlp localfile.mp3");
        System.out
                .println("        java blib.sound.javazoom.jl.player.jlp -url http://www.server.com/remotefile.mp3");
        System.out
                .println("        java blib.sound.javazoom.jl.player.jlp -url http://www.shoutcastserver.com:8000");
    }
