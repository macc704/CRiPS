...
//	}
	...
	private boolean replaceBlockChecker(Block block, BlockConnector socket) {
		...
		Block sBlock = block.getWorkspace().getEnv().getBlock(socket.getBlockID());
	...
	*/
	...
	private void replaceBlock(Block block, BlockConnector socket) {
		RenderableBlock rb = block.getWorkspace().getEnv().getRenderableBlock(block
				.getBlockID());
		RenderableBlock socketRb = block.getWorkspace().getEnv().getRenderableBlock(socket
				.getBlockID());
