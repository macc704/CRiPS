/*
 * @(#)SourceManager.java	1.12 05/11/17
 *
...
public class SourceManager {
	...
	private void notifySourcepathChanged() {
		Vector<SourceListener> l = (Vector<SourceListener>) sourceListeners
				.clone();
	...
	/**
	 * Get source object associated with a class or interface. Returns null if
	 * not available.
	 */
