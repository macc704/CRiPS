/*
 * @(#)SourceTreeTool.java	1.10 05/11/17
 *
...
public class SourceTreeTool extends JPanel {
	...
	public SourceTreeTool(Environment env) {
		...
		this.env = env;
		// this.runtime = this.env.getExecutionManager();
		this.sourceManager = this.env.getSourceManager();
		 ...
		 * tree.addTreeSelectionListener(new TreeSelectionListener() { public
		 * void valueChanged(TreeSelectionEvent e) { SourceTreeNode node =
		 * (SourceTreeNode) (e.getPath().getLastPathComponent());
