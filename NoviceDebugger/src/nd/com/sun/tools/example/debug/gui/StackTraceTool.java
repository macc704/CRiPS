/*
 * @(#)StackTraceTool.java	1.14 05/11/17
 *
...
public class StackTraceTool extends JPanel {
	...
	private class StackTraceToolListener implements ContextListener,
		...
		// ### I suspect we handle the case badly that the VM is not
		// interrupted.
	...
	private static class StackTraceListModel extends AbstractListModel<Object> {
