...
import a.slab.blockeditor.extent.SContextMenuProvider;

/**
 * ContextMenu handles all the right-click menus within the Workspace. ria
...
public class ContextMenu extends PopupMenu implements ActionListener {
	...
	private static void initAddCommentMenu() {
		addCommentItem = new MenuItem("コメントをつける");
	...
	private static void initRemoveCommentMenu() {
		removeCommentItem = new MenuItem("コメントを消去する");
	...
	private static void initCanvasMenu() {
		arrangeAllBlocks = new MenuItem("ブロックをフォーマットする"); // some workspaces
															// don't have pages
