 ...
 * 
 * The widget itself mains the bounded range b2j.model of ONE particular
 * abstract data structure, to be refered to as the abstract b2j.model.
 * This b2j.model is displayed graphically through the slider and text
 * fields.
 * 
 * The b2j.model itself has a maximum, a minimum, and a value (to be
 * consistant with all swing components that wrap a bounded range b2j.model).
 * 
 * The GUI representation of the abstract b2j.model has three text fields
 ...
 * abstract minimum of the abstract bounded range b2j.model.  The text field
 ...
 * abstract b2j.model and UI (view).  The CSliderPane's controller is
 * reponsible for three things:
 * 	1. 	keeping the slider, text fields, and abstarct b2j.model consistant; that
 ...
 * 
 * @specfield minium : float // the minimum value of this abstract bounded range b2j.model
 * @specfield maximum : float // the maximum value of this abstract bounded range b2j.model
 * @specfield value : float // the abstract value of this abstract bounded range b2j.model
 * 
 */
public class CSliderPane extends JPanel implements ComponentListener{
	...
	/** the slider that graphcally displays thhe abstract b2j.model*/
	 ...
	 * 			   reflects the current bounded range b2j.model
	 */
	...
	private abstract class CNumberTextField extends JTextField implements KeyListener, FocusListener, MouseListener{
		...
		//revaluate text widget abstract b2j.model and GUI displays
		...
		//re-evaluate abstract b2j.model and update GUI when user presses enter or escapse
