...
/*	private Point rescale(Point p){
    ...
    public void blockDropped(RenderableBlock block) {
    	//  - djwendel - this needs to choose the widget of the top block of the stack, not the widget under the block necessarily
    	...
    	/* before dropping, check if any connected blocks were dropped elsewhere.
    	   ...
    	   blocks up the stack rather than down the stack.  - this doesn't
